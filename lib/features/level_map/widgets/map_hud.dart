      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            ...
            BoxShadow(
              color: AppColors.avatarFrame.withOpacity(0.3),
              blurRadius: 8,
              spreadRadius: 1,
            ),
          ],
          ...
          child: Container(
            ...
            child: Image.network(
              ...
              errorBuilder: (context, error, stackTrace) {
                // Fallback avatar
                return Container(
                  color: AppColors.avatarBgLight,
                  child: Icon(
                    Icons.face,
                    color: AppColors.avatarBgDark,
                    size: 36,
                  ),
                );
              },
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [AppColors.plusGreenLight, AppColors.plusGreenDark],
...
/// Coins display - WHITE background with gold coin
              ...
              child: Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    shape: BoxShape.circle,
                    border: Border.all(color: AppColors.goldenBorderLight, width: 3),
                    boxShadow: [
                      BoxShadow(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [AppColors.settingsLight, AppColors.settingsDark],
            begin: Alignment.topLeft,
            end: Alignment.bottomRight,
          ),
          shape: BoxShape.circle,
          border: Border.all(
            color: AppColors.settingsHighlight,
            width: 3,
          ),
          boxShadow: [
            BoxShadow(
              color: AppColors.goldenBorder.withOpacity(0.5),
              blurRadius: 0,
              offset: const Offset(0, 3),
            ),
            BoxShadow(
